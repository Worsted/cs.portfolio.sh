...
//Above are the variables that will have text values put into them. Giving them the "p" tag will allow them to have all of the properties of the "p" tag. Including any CSS done with those tags
...
//Below are the functions that trigger the next event when you click on the button.
